...
set -gx ANDROID_HOME $HOME/.dot/Android/Sdk/
set -gx ANDROID_SDK_ROOT $HOME/.dot/Android/Sdk/
set -gx ANDROID_CMD_TOOLS $ANDROID_HOME/platform-tools/bin

for dir in $HOME/.local/bin $NPM_CONFIG_PREFIX/bin $BUN_INSTALL/bin $CARGO_HOME/bin $DENO_INSTALL_ROOT/bin $FLUTTER_HOME/bin $ANDROID_CMD_TOOLS
